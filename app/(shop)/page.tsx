  ...
  return (
    <main style={{ background: COLORS.bg }}>
      <section className="mx-auto grid max-w-[1200px] gap-4 px-4 py-5 sm:gap-6 md:px-6 md:py-8 lg:grid-cols-[1.08fr_.92fr] lg:py-10">
        ...
        <Link href="/drop" className="group relative min-h-[340px] overflow-hidden rounded-[24px] sm:min-h-[400px] lg:min-h-[480px] lg:rounded-[28px]" style={{ background: COLORS.accentSoft }}>
